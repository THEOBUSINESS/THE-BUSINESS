...
+~~Developer By : @Noor_OS On Telegram ,
...
git clone https://github.com/THEOBUSINESS/The-Business.git
...
libpython-dev expat libexpat1-dev -y && cd $HOME && rm -rf The-Business && rm -rf .telegram-cli && git clone https://github.com/THEOBUSINESS/The-Business.git && cd superflux-bot && ./launch.sh install && ./launch.sh
~~~~~
